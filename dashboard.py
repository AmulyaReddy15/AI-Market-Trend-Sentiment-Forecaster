...
def run_scheduler():
    ...
    schedule.every().day.at("10:25").do(news.get_news_data)
    schedule.every().day.at("11:00").do(reddit_api.reddit_api)
    # schedule.every(10).sunday.at("20:20").do(reddit_api.reddit_api)
    # schedule.every().day.at("18:36").do(rapid_api.rapid_get_data)
